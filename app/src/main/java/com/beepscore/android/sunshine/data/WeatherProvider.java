...
public class WeatherProvider extends ContentProvider {
    ...
    // Class static constructor, can access static variables but not instance variables
    static {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        // * matches weather string, # matches location number
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                // return CONTENT_ITEM_TYPE, a single row
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;
            case WEATHER_WITH_LOCATION:
                // return CONTENT_TYPE, may contain multiple items
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        // must use uri argument passed in to method, not returnUri
