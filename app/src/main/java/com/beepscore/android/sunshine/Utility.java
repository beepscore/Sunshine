...
// Reference
// Udacity supplied methods
// https://github.com/udacity/Sunshine-Version-2.git
...
public class Utility {
    ...
    /**
     * Helper method to convert the database representation of the date
     * into something to display to users.
    ...
    public static String getFriendlyDayString(Context context, long dateInMillis) {
        ...
        // If the date we're building the String for is today's date,
        // the format is "Today, June 24"
